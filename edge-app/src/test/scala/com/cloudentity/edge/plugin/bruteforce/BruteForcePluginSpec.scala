package com.cloudentity.edge.plugin.bruteforce
...
class BruteForcePluginSpec extends ApiGatewayTest with MustMatchers  {
  ...
  override def getMetaConfPath(): String = "src/test/resources/bruteforce/meta-config.json"
