package com.cloudentity.edge.plugin.authn.openapi

import io.circe.syntax._
import com.cloudentity.edge.plugin.openapi.{ConvertOpenApiResponse, ConvertedOpenApi}
import com.cloudentity.edge.domain.flow.{GroupMatchCriteria, PathPattern, PathPrefix, PluginConf, PluginName, TargetHost}
...
import com.cloudentity.edge.plugin.impl.authn.openapi.AuthnPluginOpenApiConverter.convert
import com.cloudentity.edge.plugin.impl.authn.{AuthnApiOpenApiConf, AuthnPluginConf}
