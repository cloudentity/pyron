...
class TargetClientWithSmartHttpAcceptanceSpec extends ApiGatewayTest with MustMatchers {
  ...
  override def getMetaConfPath(): String = "src/test/resources/http/meta-config.json"
