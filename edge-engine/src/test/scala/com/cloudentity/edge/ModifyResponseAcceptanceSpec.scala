...
class ModifyResponseAcceptanceSpec extends ApiGatewayTest with MockUtils {
  override def getMetaConfPath(): String = "src/test/resources/modify-response/meta-config-test.json"
