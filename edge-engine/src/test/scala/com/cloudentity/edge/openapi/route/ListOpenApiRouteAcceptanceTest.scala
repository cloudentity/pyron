...
import com.cloudentity.edge.domain.openapi.DiscoverableServiceId
import com.cloudentity.edge.openapi.ListOpenApiRoute.{ListOpenApiResponse, ServiceMetadata, Url}
...
class ListOpenApiRouteAcceptanceTest extends EdgeAcceptanceTest with MustMatchers with MockUtils {
