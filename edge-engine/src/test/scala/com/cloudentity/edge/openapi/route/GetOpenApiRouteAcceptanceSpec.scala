package com.cloudentity.edge.admin.route.openapi
...
object GetOpenApiRouteAcceptanceSpec {
...
class GetOpenApiRouteAcceptanceSpec extends ApiGatewayTest with MockUtils {
  ...
  def shouldConvertForDiscoverableService(): Unit = {
    ...
    val jsonOpenApiMatcher = new OpenApiMatcher(GetOpenApiRouteAcceptanceSpec.expectedOpenApi, io.swagger.util.Json.pretty())
  ...
  def shouldProduceApiDocsInYamlFormat(): Unit = {
    ...
    val yamlOpenApiMatcher = new OpenApiMatcher(GetOpenApiRouteAcceptanceSpec.expectedOpenApi, io.swagger.util.Yaml.pretty())
