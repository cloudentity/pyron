...
class SmartTargetClientsReloadSpec extends ApiGatewayTest with MockUtils {
  override def getMetaConfPath(): String = "src/test/resources/smart-clients-reload/meta-config.json"
