...
import com.cloudentity.edge.domain.flow.{DiscoverableServiceRule, EndpointMatchCriteria, PathMatching, PathPattern, PathPrefix, PluginConf, PluginName, ProxyServiceRule, RewriteMethod, RewritePath, ServiceClientName, StaticServiceRule, TargetHost, TargetServiceRule}
